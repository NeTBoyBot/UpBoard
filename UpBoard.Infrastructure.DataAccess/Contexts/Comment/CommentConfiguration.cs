...
{
    public class CommentConfiguration : IEntityTypeConfiguration<UpBoard.Domain.Comment>
    {
        public void Configure(EntityTypeBuilder<UpBoard.Domain.Comment> builder)
        {
